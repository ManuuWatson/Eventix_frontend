...
const CheckoutPage = () => {
  ...
  const subtotal = ticketType.price * formData.quantity;
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              {event.paymentMethods.includes('Stripe') && <div className={`border rounded-lg p-4 cursor-pointer transition-colors ${selectedPaymentMethod === 'Stripe' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200'}`} onClick={() => setSelectedPaymentMethod('Stripe')}>
              ...
              {event.paymentMethods.includes('PayPal') && <div className={`border rounded-lg p-4 cursor-pointer transition-colors ${selectedPaymentMethod === 'PayPal' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200'}`} onClick={() => setSelectedPaymentMethod('PayPal')}>
                  <div className="flex items-center">
              ...
              {event.paymentMethods.includes('M-Pesa') && <div className={`border rounded-lg p-4 cursor-pointer transition-colors ${selectedPaymentMethod === 'M-Pesa' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-200'}`} onClick={() => setSelectedPaymentMethod('M-Pesa')}>
                  <div className="flex items-center">
