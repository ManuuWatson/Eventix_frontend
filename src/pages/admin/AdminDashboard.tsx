...
import { LayoutDashboardIcon, CalendarIcon, UsersIcon, AlertTriangleIcon, SettingsIcon, LogOutIcon } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  <nav className="space-y-1">
    ...
    <Link
      to="/admin/events"
      className={`flex items-center px-4 py-3 rounded-md ${
        activePage === 'events' ? 'bg-gray-800' : 'hover:bg-gray-800'
      }`}
    ...
    <Link
      to="/admin/users"
      className={`flex items-center px-4 py-3 rounded-md ${
        activePage === 'users' ? 'bg-gray-800' : 'hover:bg-gray-800'
      }`}
    ...
    <Link
      to="/admin/reports"
      className={`flex items-center px-4 py-3 rounded-md ${
        activePage === 'reports' ? 'bg-gray-800' : 'hover:bg-gray-800'
      }`}
